<?php 
    ...
    if (empty($numrecords) || !is_numeric($numrecords)) {
        $sql1 = "SELECT count(*) as total FROM \"tbladmins\" where $where AND adminpermission = 4";
        ...
        <div class="container-fluid">
            <div class="card">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="searchAdName" name="searchAdName"
                                        placeholder="Patients Name" value="<?=$searchAdName?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="searchAdEmail" name="searchAdEmail"
                                        placeholder="Patients Email" value="<?=$searchAdEmail?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                ...
                <div class="card-body">
                    <?php                     
                        try {
                            $selectSql = "SELECT * FROM tbladmins where $where AND adminpermission = 4 ORDER BY \"id\" DESC LIMIT $numRecordPerPage OFFSET $start";
